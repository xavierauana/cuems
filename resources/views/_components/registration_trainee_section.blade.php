<fieldset class="trainee">
        ...
        <div class="form-group row">
                ...
                <div class="col-sm-9">
                    {{Form::select('training_organisation', array_merge(["--- Please Select ---"],array_combine(\App\Institution::pluck('name')->toArray(),\App\Institution::pluck('name')->toArray()), [0=>"Other"]),null, ['class'=>'form-control select2', 'required'])}}
        ...
        <div class="form-group row">
            <label class="institution col-sm-3 col-form-label">Or Other</label>
            <div class="col-sm-9">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6 col-md-8  col-lg-9">
               {{Form::text("training_organisation_address",null,['class'=>'form-control'])}}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6 col-md-8  col-lg-9">
                {{Form::text("supervisor_position",null,['class'=>'form-control'])}}
